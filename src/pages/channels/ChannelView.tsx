                            ...
                            {!this.props.readOnly &&
                                    <td className={"text-right"}>
                                        <OverlayTrigger placement="top"
                                                        overlay={<Tooltip
                                                                id={`tooltip-delete-${index}`}>Elimina</Tooltip>}>
                                            <FaTrash role="button" className="mr-3"
                                                     onClick={() => this.handlePaymentTypeDelete(item)}/>
                                        </OverlayTrigger>
                                    </td>
                            }
                        </tr>
                ...
                <div className="container-fluid creditor-institutions">
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            ...
                            {isLoading && (
                                    <div className="text-center"><FaSpinner className="spinner" size={28}/></div>)}
                            {
                                    !isLoading && (
                                            <>
                                                <div className="row">
                                                    ...
                                                    <Card.Body>
                                                        <div className="row">
                                                            ...
                                                            <Form.Group controlId="primitive_version" className="col-md-2">
                                                                <Form.Label>Versione primitive <span
                                                                        className="text-danger">*</span></Form.Label>
                                                                <Form.Control type={"number"} name="primitive_version" min={1}
                                                                              max={2}
                                                        ...
                                                        <p className="alert alert-info">
                                                            <FaInfoCircle/> Impostare la password a <span
                                                                className="badge badge-light">PLACEHOLDER</span> e disabilitare
                                                            il proxy.
                                                        </p>
                                                        <div className="card">
                                                            <div className="card-header">Configurazione per
                                                                endpoint <b>Servizio</b></div>
                                                            <div className="card-body">
                                                                <div className="row">
                                                                    ...
                                                                    <Form.Group controlId="target_port" className="col-md-2">
                                                                        ...
                                                                        <Form.Control name="target_port" type="number" min={1}
                                                                                      max={65535}
                                                        ...
                                                        <div className="card mt-2">
                                                            <div className="card-header">Configurazione per endpoint <b>Servizio
                                                                NMP</b></div>
                                                            <div className="card-body">
                                                                <div className="row">
                                                                    <Form.Group controlId="target_host_nmp"
                                                                                className="col-md-5">
                                                                        <Form.Label>Indirizzo</Form.Label>
                                                                    ...
                                                                    <Form.Group controlId="target_port_nmp"
                                                                                className="col-md-2">
                                                                        <Form.Label>Porta</Form.Label>
                                                                        <Form.Control name="target_port_nmp" type="number"
                                                                                      min={1} max={65535}
                                                                                      value={this.props.channel.target_port_nmp}
                                                                                      onChange={(e) => this.handleChange(e)}
                                                                                      readOnly={this.props.readOnly}/>
                                                                    </Form.Group>
                                                                    <Form.Group controlId="target_path_nmp"
                                                                                className="col-md-5">
                                                                        <Form.Label>Path</Form.Label>
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <Form.Group controlId="proxy_port" className="col-md-2">
                                                                ...
                                                                <Form.Control name="proxy_port" placeholder="" type="number"
                                                                              value={this.props.channel.proxy_port} min={1}
                                                                              max={65535}
                                                                              onChange={(e) => this.handleChange(e)}
                                                                              readOnly={this.props.readOnly}/>
                                                            </Form.Group>
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <Form.Group controlId="flag_psp_cp"
                                                                ...
                                                                <OverlayTrigger placement="top"
                                                                                overlay={<Tooltip id={`tooltip-details-flag_psp_cp`}>Il FLAG_PSP_CP rappresenta l&apos;abilitazione ad effettuare il travaso delle informazioni presenti in additional payment information nei tag relativi al pagamento con carte per le Pa in V1</Tooltip>}>
                                                                    <FaInfoCircle></FaInfoCircle>
                                                                </OverlayTrigger>

                                                            </Form.Group>

                                                            <Form.Group controlId="rt_push"
                                                                        className="col-md-2 custom-control-box">
                                                                <Form.Check
                                                                        custom
                                                            ...
                                                            <Form.Group controlId="card_chart"
                                                                        className="col-md-2 custom-control-box">
                                                                <Form.Check
                                                                        custom
