            ...
            <div className="container-fluid channel">
                <div className="row">
                    <div className="col-md-12 mb-5">
                        <Breadcrumb>
                            <Breadcrumb.Item href="/payment-service-providers">Canali</Breadcrumb.Item>
                        ...
                        {isLoading && (<div className="text-center"><FaSpinner className="spinner" size={28}/></div>)}
                        {
                            !isLoading && (
                                <>
                                    ...
                                    {/*<div className="row">*/}
                                    {/*    <div className="col-md-12">*/}
                                    {/*        <h2>{this.state.channel.business_name}</h2>*/}
                                    {/*    </div>*/}
                                    {/*</div>*/}
                                    {/*<div className="row">*/}
                                    ...
                                    {/*                      value={this.state.channel.psp_code}*/}
                                    {/*                      readOnly/>*/}
                                    {/*    </Form.Group>*/}
                                    ...
                                    {/*            custom*/}
                                    {/*            disabled*/}
                                    {/*            defaultChecked={this.state.channel.agid_psp === true}*/}
                                    {/*            type={'checkbox'}*/}
                                    {/*            id={'agid-psp'}*/}
                                    {/*            label={'PSP interno'}*/}
                                    {/*        />*/}
                                    ...
                                    {/*            custom*/}
                                    {/*            disabled*/}
                                    {/*            defaultChecked={this.state.channel.stamp === true}*/}
                                    {/*            type={'checkbox'}*/}
                                    {/*            id={'stamp'}*/}
                                    ...
                                    {/*            custom*/}
                                    {/*            disabled*/}
                                    {/*            defaultChecked={this.state.channel.transfer === true}*/}
                                    {/*            type={'checkbox'}*/}
                                    {/*            id={'transfer'}*/}
